...
# as the url is returned here iam downloading the file here please copy the same in main.


import urllib
def download_gif(string, integer_count ):
    a = 'sample'
    b = '.gif'
    urllib.urlretrieve(getgifurl( string ), a + str( integer_count ) + b)
